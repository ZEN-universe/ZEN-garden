...
class ProductionTechnology(ConversionTechnology):
    # empty list of elements
    listOfElements = []

    def __init__(self, tech):
        """init production technology object
        :param tech: name of added technology"""

        logging.info(f'Initialize production technology {tech}')
        super().__init__(tech)
        # store input data
        self.storeInputData()
        # add ConversionTechnology to list
        ProductionTechnology.addElement(self)
    ...
    def constructSets(cls):
        """ constructs the pe.Sets of the class <ProductionTechnology> """
        pass

    @classmethod
    def constructParams(cls):
        """ constructs the pe.Params of the class <ProductionTechnology> """
