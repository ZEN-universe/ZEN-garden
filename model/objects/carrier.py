...
class Carrier(Element):
    ...
    def storeInputData(self):
        ...
        # raw import
        self.rawTimeSeries = {}
        self.rawTimeSeries["demandCarrier"] = self.dataInput.extractInputData(self.inputPath, "demandCarrier",
                                                                              ["setNodes", "setTimeSteps"],
                                                                              timeSteps=setBaseTimeSteps)
        self.rawTimeSeries["availabilityCarrierImport"] = self.dataInput.extractInputData(self.inputPath,
                                                                                          "availabilityCarrier",
                                                                                          ["setNodes", "setTimeSteps"],
                                                                                          column="availabilityCarrierImport",
                                                                                          timeSteps=setBaseTimeSteps)
        self.rawTimeSeries["availabilityCarrierExport"] = self.dataInput.extractInputData(self.inputPath,
                                                                                          "availabilityCarrier",
                                                                                          ["setNodes", "setTimeSteps"],
                                                                                          column="availabilityCarrierExport",
                                                                                          timeSteps=setBaseTimeSteps)
        self.rawTimeSeries["exportPriceCarrier"] = self.dataInput.extractInputData(self.inputPath, "priceCarrier",
                                                                                   ["setNodes", "setTimeSteps"],
                                                                                   column="exportPriceCarrier",
                                                                                   timeSteps=setBaseTimeSteps)
        self.rawTimeSeries["importPriceCarrier"] = self.dataInput.extractInputData(self.inputPath, "priceCarrier",
                                                                                   ["setNodes", "setTimeSteps"],
                                                                                   column="importPriceCarrier",
                                                                                   timeSteps=setBaseTimeSteps)
...
def constraintCostCarrierTotalRule(model):
    ...
    return (model.costCarrierTotal ==
            sum(model.costCarrier[carrier, node, time] * model.timeStepsCarrierDuration[carrier, time]
...
def constraintCarbonEmissionsCarrierTotalRule(model):
    ...
    return (model.carbonEmissionsCarrierTotal ==
            sum(model.carbonEmissionsCarrier[carrier, node, time] * model.timeStepsCarrierDuration[carrier, time]
                for carrier, node, time in Element.createCustomSet(["setCarriers", "setNodes", "setTimeStepsCarrier"])))
