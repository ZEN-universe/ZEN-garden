...
system["numberTimeStepsDefault"]                    = 15 # default number of operational time steps, only used in single-grid time series aggregation TODO number of time steps per period = 1
