.. _dataset_examples.dataset_examples:
...
---------------------
This example adds a piecewise affine representation of conversion-technology
capital expenditures to demonstrate nonlinear economies of scale. See
:ref:`math_formulation.pwa_constraints` for the mathematical formulation.
