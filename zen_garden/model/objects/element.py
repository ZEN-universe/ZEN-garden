            ...
            if list_index[0] in indexing_sets:
                ...
                for element in model.find_component(list_index[0]):
                    ...
                    for index in list_index[1:]:
                        ...
                        elif index == "set_selfish_nodes":
                            if "set_selfish_nodes" in system:
                                set_selfish_nodes = sorted(list(set(model.set_nodes).intersection(system["set_selfish_nodes"])))
                                list_sets.append(set_selfish_nodes)
                            else:
                                list_sets.append(model.set_nodes)
