...
class TransportTechnology(Technology):
    ...
    def get_capex_transport(self):
        ...
        if self.energy_system.system['double_capex_transport']:
            ...
            self.capex_specific = self.data_input.extract_input_data("capex_specific", index_sets=["set_edges", "set_time_steps"], time_steps=set_time_steps_yearly)
            self.capex_per_distance = self.data_input.extract_input_data("capex_per_distance", index_sets=["set_edges", "set_time_steps"], time_steps=set_time_steps_yearly)
