...
class TransportTechnology(Technology):
    ...
    def construct_params(cls, optimization_setup):
        ...
        # carrier losses
        optimization_setup.parameters.add_parameter(name="transport_loss_factor", index_names=["set_transport_technologies"], doc='carrier losses due to transport with transport technologies', calling_class=cls)
