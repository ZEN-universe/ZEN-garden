...
class RetrofittingTechnology(ConversionTechnology):
    ...
    def store_input_data(self):
        ...
        self.retrofit_flow_coupling_factor = self.data_input.extract_input_data("retrofit_flow_coupling_factor", index_sets=["set_nodes", "set_time_steps"], unit_category={"emissions": 1, "energy_quantity": -1}) #same indices as conversion factor?
