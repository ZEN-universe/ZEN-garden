"""Abstract base class for ZEN-model's component registries."""
...
class Registry:
    """Base for the per-kind registries that prepare data to suit linopy."""

    def __init__(self) -> None:
        """Instantiate object of Registry class."""
