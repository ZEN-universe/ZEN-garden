...
for filter_component, title, y_axis, y_axis_label in cost_components:
    df = results_JS.filter_boxplot(parent_folder, folders, specific_scenario_name, filter_component=filter_component)
    pareto_df = results_JS.filter_pareto_group(df, custom_order, pareto_group)
    plot_results.plot_pareto_front(pareto_df, parent_folder, output_path, title=title, unit_co2=unit_co2, unit_y_axis=unit_cost, y_axis=y_axis, y_axis_label=y_axis_label, save_fig=save_fig)
...
capacities_df = results_JS.filter_boxplot(parent_folder, folders, filter_component='capacities', df_tech_cap=df_tech_cap, specific_scenario_name='analysis_1806')
...
for y_axis, title, unit_y_axis, y_axis_label in capacity_components:
    plot_results.plot_pareto_front(capacities_pareto_df, parent_folder, output_path, title=title, unit_co2=unit_co2, unit_y_axis=unit_y_axis, y_axis=y_axis, y_axis_label=y_axis_label, save_fig=save_fig)

flow_import_df = results_JS.filter_boxplot(parent_folder, folders, filter_component='flow_import', specific_scenario_name='analysis_1806')
...
for y_axis, title, unit_y_axis, y_axis_label in flow_import_components:
    plot_results.plot_pareto_front(flow_import_pareto_df, output_path, parent_folder, title=title, unit_co2=unit_co2, unit_y_axis=unit_y_axis, y_axis=y_axis, y_axis_label=y_axis_label, save_fig=save_fig)
for y_axis, title, unit_y_axis, y_axis_label in flow_import_components:
    plot_results.plot_pareto_front_cost(flow_import_pareto_df, parent_folder, output_path, title=title, unit_cost=unit_cost, unit_y_axis=unit_y_axis, y_axis=y_axis, y_axis_label=y_axis_label, save_fig=True)
for y_axis, title, unit_y_axis, y_axis_label in capacity_components:
    plot_results.plot_pareto_front_cost(capacities_pareto_df, parent_folder, output_path, title=title, unit_cost=unit_cost, unit_y_axis=unit_y_axis, y_axis=y_axis, y_axis_label=y_axis_label, save_fig=True)