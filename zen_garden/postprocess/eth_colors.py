...
class ETHColors:
    ...
    def setColorsTechs(self):
        self.colors["techs"] = {"natural_gas_turbine": self.getColor("petrol"), "hard_coal_plant": self.getColor("grey", "dark"), "natural_gas_turbine_CCS": self.getColor("petrol", 60),
            ...
            "oil_boiler": self.getColor("bronze", 60), "electrode_boiler": self.getColor("blue", 60), "others": self.getColor("grey", 60), "battery": self.getColor("bronze", 60),
            "hydrogen_storage": self.getColor("purple", 60), "natural_gas_storage": self.getColor("petrol", 60), "pumped_hydro": self.getColor("blue", 60), "power_line": self.getColor("blue", 60),
